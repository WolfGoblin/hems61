import { Ambulance, Stethoscope, GraduationCap, Hospital, Activity } from "lucide-react";

export default function Services() {
    const services = [
        {
            title: "24/7 Nationwide Accident Response",
            description: "Highway coverage, rapid deployment from 17+ bases, ideal for travellers and trucking companies. Main benefit is ~20-minute average response time.",
            icon: Ambulance,
        },
        {
            title: "Certified Trauma Specialists",
            description: "Paramedics and doctors focused on trauma and critical care. Advanced life support provided on-scene for accident and critical patients.",
            icon: Stethoscope,
        },
        {
        ...
        },
        {
            ...
            description: "Safe, medically supervised inter-facility transfers tailored for both private patients and hospitals ensuring continuous care.",
            icon: Hospital,
        },
    ];
    ...
    return (
        <section id="services" className="py-24 bg-slate-50 relative">
            <div className="absolute top-0 left-0 w-full h-[50vh] bg-slate-900 -z-10" />

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-2xl mx-auto mb-16 text-white pt-12">
